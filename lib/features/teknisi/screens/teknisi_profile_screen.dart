...
class TeknisiProfileScreen extends StatelessWidget {
  ...
  static const _waDev = '6289528128855';
                  ...
                  child: Column(
                    children: [
                      InkWell(
                        onTap: () => _launchWA(
                          _waAdminSupport,
                          'Halo admin support, saya teknisi ${user.name} ingin menyampaikan informasi.',
                        ),
                      ...
                      InkWell(
                        onTap: () => _launchWA(
                          _waDev,
                          'Halo developer, saya teknisi ${user.name} ada kendala terkait penggunaan aplikasi MySimtek',
                        ),
                        borderRadius: const BorderRadius.vertical(
